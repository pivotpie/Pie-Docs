...
export const AutoClassificationCenter: React.FC<AutoClassificationCenterProps> = ({
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'ready': case 'completed': case 'active': return 'text-green-300 glass-panel border-green-400/30';
      case 'training': case 'running': case 'pending': return 'text-blue-300 glass-panel border-blue-400/30';
      case 'error': case 'failed': return 'text-red-300 glass-panel border-red-400/30';
      case 'deploying': return 'text-yellow-300 glass-panel border-yellow-400/30';
      default: return `${theme === 'dark' ? 'text-white/60' : 'text-white/60'} glass-panel border-white/20`;
    }
  };
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {rules.map(rule => (
          <div
            key={rule.id}
            className="glass-card rounded-lg border border-white/20 p-6 hover:scale-105 transition-all duration-300"
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1">
                <div className="flex items-center space-x-3 mb-2">
                  <h4 className={`text-lg font-semibold ${theme === 'dark' ? 'text-white' : 'text-white/90'}`}>
                    {rule.name}
                  </h4>
                  <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium border ${
                    rule.isActive ? 'text-green-300 glass-panel border-green-400/30' : `${theme === 'dark' ? 'text-white/60' : 'text-white/60'} glass-panel border-white/20`
                  }`}>
                    {rule.isActive ? 'Active' : 'Inactive'}
                  </span>
                </div>

                <p className={`${theme === 'dark' ? 'text-white/80' : 'text-white/80'} text-sm mb-3`}>
                  {rule.description}
                </p>

                <div className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    <span className={`${theme === 'dark' ? 'text-white/60' : 'text-white/60'}`}>Accuracy</span>
                  ...
                  <div className="flex items-center justify-between text-sm">
                    <span className={`${theme === 'dark' ? 'text-white/60' : 'text-white/60'}`}>Confidence</span>
                    <span className={`font-medium ${theme === 'dark' ? 'text-white' : 'text-white/90'}`}>
                  ...
                  <div className="flex items-center justify-between text-sm">
                    <span className={`${theme === 'dark' ? 'text-white/60' : 'text-white/60'}`}>Documents Processed</span>
                    <span className={`font-medium ${theme === 'dark' ? 'text-white' : 'text-white/90'}`}>
                  ...
                  <div className="flex items-center justify-between text-sm">
                    <span className={`${theme === 'dark' ? 'text-white/60' : 'text-white/60'}`}>Last Run</span>
                    <span className={`font-medium ${theme === 'dark' ? 'text-white' : 'text-white/90'}`}>
              ...
              <div className="flex items-start space-x-2">
                <button
                  ...
                  className={`p-2 rounded-md hover:scale-110 transition-all duration-200 ${
                    rule.isActive
                      ...
                      : `${theme === 'dark' ? 'text-white/60' : 'text-white/60'} hover:bg-white/10`
                  }`}
                ...
                <button
                  ...
                  className={`p-2 ${theme === 'dark' ? 'text-white/60' : 'text-white/60'} hover:text-blue-400 hover:bg-blue-400/20 rounded-md hover:scale-110 transition-all duration-200`}
                  title="View details"
                >
                ...
                <button
                  ...
                  className={`p-2 ${theme === 'dark' ? 'text-white/60' : 'text-white/60'} hover:text-red-400 hover:bg-red-400/20 rounded-md hover:scale-110 transition-all duration-200`}
                  title="Delete rule"
                >
            ...
            <div className="mt-4 pt-4 border-t border-white/20">
              <div className={`flex items-center justify-between text-xs ${theme === 'dark' ? 'text-white/60' : 'text-white/60'} mb-1`}>
                <span>Performance</span>
                <span>{formatAccuracy(rule.performance.accuracy)}</span>
              </div>
              <div className="w-full glass-panel rounded-full h-2">
                <div
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {rule.actions.category && (
                <span className="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium glass-panel border border-blue-400/30 text-blue-300">
              ...
              {rule.actions.tags?.slice(0, 2).map(tag => (
                <span
                  key={tag}
                  className="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium glass-panel border border-green-400/30 text-green-300"
                >
  ...
  const renderModelsTab = () => (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <button className="flex items-center px-4 py-2 btn-glass rounded-md hover:scale-105 transition-all duration-300">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        {models.map(model => (
          <div
            key={model.id}
            className="glass-card rounded-lg border border-white/20 p-6"
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1">
                <div className="flex items-center space-x-3 mb-2">
                  ...
                  <span className={`text-sm ${theme === 'dark' ? 'text-white/60' : 'text-white/60'}`}>v{model.version}</span>
                  <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium border ${getStatusColor(model.status)}`}>
                    {model.status}
                  </span>
                </div>

                <div className={`flex items-center space-x-4 text-sm ${theme === 'dark' ? 'text-white/80' : 'text-white/80'} mb-3`}>
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
              <div className="text-center p-3 glass-panel rounded-lg">
                ...
                <div className={`text-xs ${theme === 'dark' ? 'text-white/60' : 'text-white/60'}`}>Accuracy</div>
              </div>
              ...
              <div className="text-center p-3 glass-panel rounded-lg">
                ...
                <div className={`text-xs ${theme === 'dark' ? 'text-white/60' : 'text-white/60'}`}>F1 Score</div>
              </div>
              ...
              <div className="text-center p-3 glass-panel rounded-lg">
                ...
                <div className={`text-xs ${theme === 'dark' ? 'text-white/60' : 'text-white/60'}`}>Training Samples</div>
              </div>
              ...
              <div className="text-center p-3 glass-panel rounded-lg">
                ...
                <div className={`text-xs ${theme === 'dark' ? 'text-white/60' : 'text-white/60'}`}>Avg. Processing</div>
              </div>
            </div>

            {/* Categories */}
            <div className="mb-4">
              <div className={`text-sm ${theme === 'dark' ? 'text-white/60' : 'text-white/60'} mb-2`}>Categories</div>
              <div className="flex flex-wrap gap-1">
                {model.trainingData.categories.slice(0, 3).map(category => (
                  <span
                    key={category}
                    className="inline-flex items-center px-2 py-1 rounded text-xs font-medium glass-panel border border-blue-400/30 text-blue-300"
                  >
                    {category}
                  </span>
                ))}
            ...
            <div className={`flex items-center justify-between pt-4 border-t border-white/20`}>
              <div className={`text-xs ${theme === 'dark' ? 'text-white/60' : 'text-white/60'}`}>
              ...
              <div className="flex items-center space-x-2">
                ...
                <button
                  ...
                  className={`p-2 ${theme === 'dark' ? 'text-white/60' : 'text-white/60'} hover:text-green-400 hover:bg-green-400/20 rounded-md hover:scale-110 transition-all duration-200`}
                  title="Deploy model"
                >
      ...
      <div className="space-y-4">
        {jobs.map(job => (
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                  <div>
                    <span className={`${theme === 'dark' ? 'text-white/60' : 'text-white/60'}`}>Progress</span>
                    <div className={`font-medium ${theme === 'dark' ? 'text-white' : 'text-white/90'}`}>
                      {job.progress}%
                    </div>
                  </div>

                  <div>
                    <span className={`${theme === 'dark' ? 'text-white/60' : 'text-white/60'}`}>Processed</span>
                    <div className={`font-medium ${theme === 'dark' ? 'text-white' : 'text-white/90'}`}>
                  ...
                  <div>
                    <span className={`${theme === 'dark' ? 'text-white/60' : 'text-white/60'}`}>Successful</span>
                  ...
                  <div>
                    <span className={`${theme === 'dark' ? 'text-white/60' : 'text-white/60'}`}>Failed</span>
            ...
            {/* Progress bar */}
            <div className="mb-4">
              <div className={`flex items-center justify-between text-sm ${theme === 'dark' ? 'text-white/80' : 'text-white/80'} mb-1`}>
                <span>Progress</span>
            ...
            {/* Job details */}
            <div className={`flex items-center justify-between text-sm ${theme === 'dark' ? 'text-white/60' : 'text-white/60'}`}>
              ...
              <div className="mt-4 pt-4 border-t border-white/20">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                  <div className="text-center">
                    ...
                    <div className={`${theme === 'dark' ? 'text-white/60' : 'text-white/60'}`}>Categorized</div>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <div className={`${theme === 'dark' ? 'text-white/60' : 'text-white/60'}`}>Tagged</div>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <div className={`${theme === 'dark' ? 'text-white/60' : 'text-white/60'}`}>Moved</div>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <div className={`${theme === 'dark' ? 'text-white/60' : 'text-white/60'}`}>Errors</div>
                  </div>
                </div>
              </div>
            )}
  ...
  if (loading) {
    return (
      <div className="space-y-4">
        <div className="glass-panel rounded-lg p-4 border border-white/20">
          <LoadingSkeleton height={40} width={300} />
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="glass-panel border border-white/20 rounded-lg p-6">
    ...
    <div className={`auto-classification-center ${className}`} dir="ltr">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center space-x-3">
          <div className={`flex items-center space-x-2 text-sm ${theme === 'dark' ? 'text-white/80' : 'text-white/80'}`}>
      ...
      <div className="tab-content">
        ...
        {activeTab === 'analytics' && (
          <div className="text-center py-12">
            <ChartBarIcon className={`w-12 h-12 ${theme === 'dark' ? 'text-white/60' : 'text-white/60'} mx-auto mb-4`} />
            <h3 className={`text-lg font-medium ${theme === 'dark' ? 'text-white' : 'text-white/90'} mb-2`}>
