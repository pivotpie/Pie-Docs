...
SELECT
    ...
    't1: approval_requests' as table1,
    't2: approval_chains' as table2,
    't3: approval_chain_steps' as table3,
    't4: approval_actions' as table4,
    'Using existing approval_requests for annotations' as note;

SELECT
    'Existing Tags System' as info,
    't1: tags (tag definitions)' as table1,
    't2: document_tags (junction)' as table2,
